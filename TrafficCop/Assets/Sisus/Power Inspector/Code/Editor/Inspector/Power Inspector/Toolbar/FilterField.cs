...
namespace Sisus
{
	...
	public class FilterField
	{
		...
		private void SaveCursorPositions()
		{
		...
		{
			int id = GUIUtility.GetControlID(TextFieldHash, FocusType.Keyboard, position);
			return DrawFilterField(inspector, id, position, filterString, setIsSelected, out textChanged);
		}
