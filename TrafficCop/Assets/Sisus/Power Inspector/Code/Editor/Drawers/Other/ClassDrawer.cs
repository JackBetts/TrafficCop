...
namespace Sisus
{
	...
	public class ClassDrawer : UnityObjectDrawer<ClassDrawer, Object>, IRootDrawer
	{
		...
		{
			ParentDrawerUtility.GetStaticMemberBuildList(this, MemberHierarchy, ref memberBuildList, DebugMode, FieldVisibility.AllPublic, PropertyVisibility.AllPublic, MethodVisibility.AllPublic);
		}
