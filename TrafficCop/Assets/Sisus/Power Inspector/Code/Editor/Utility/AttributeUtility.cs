...
namespace Sisus
{
	public static class AttributeUtility
	{
		...
		public static bool HasAttribute<TAttribute>([NotNull]MemberInfo member) where TAttribute : Attribute
		{
			object[] attributes;
			if(AttributesByMember.TryGetValue(member, out attributes))
			{
			...
			return member.GetCustomAttribute<TAttribute>(InheritMemberAttributes) != null;
			#else
			return member.GetCustomAttributes(typeof(TAttribute), InheritMemberAttributes).Length > 0;
			#endif
		}
